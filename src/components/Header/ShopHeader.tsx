...
const ShopHeader = ({ subTitle, children }: HeaderProps) => {
  ...
  return (
    <header
      className={`sticky top-0 z-10 flex w-full flex-col transition-transform duration-300 ${isVisible ? "translate-y-0" : "-translate-y-[3.875rem]"}`}
    >
